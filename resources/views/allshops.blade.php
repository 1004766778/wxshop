        ...
        <div class="all-list-wrapper">
            ...
            <div class="menu-list-wrapper" id="divSortList">
                <ul id="sortListUl" class="list">
                    ...
                    @foreach($arr as $v)
                    <li id="removediv"><span class='items' cate_id="{{$v->cate_id}}">{{$v->cate_name}}</span></li>
                    @endforeach
                </ul>
            </div>
                            ...
                            <ul id="ulGoodsList" class="mui-table-view mui-table-view-chevron">
                                ...
                                <li>
                                    <span class="gList_l fl">        
                                       <a href="{{url('shopcontent')}}/{{$v->goods_id}}"><img class="lazy"  data-original="/goodsimg/{{$v->goods_img}}"></a>
                                    </span>    
                                    <div class="gList_r">        
...
@section('my-js')
    ...
    $('#sortListUl li').click(function(){
        ...
        //console.log(cate_id);
         $.post(
         "allshopsDo",
         {cate_id:cate_id,_token:$('input[name=_token]').val()},
         function(res){
            //console.log(res)
